...
//!
//! Requires:
//! - A Kind cluster with `MetalLB`, Istio, Praxis, and Gateway deployed (use `praxis-forge stack apply e2e` or
//!   equivalent)
//! - llm-katan reachable at 3.147.232.199:443
//! - Set `GATEWAY_URL` to the gateway `LoadBalancer` IP: `export GATEWAY_URL=http://$(kubectl get svc e2e-gateway-istio
